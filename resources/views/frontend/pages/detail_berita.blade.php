        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-dataRombel-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-dataRombel" type="button" role="tab" aria-controls="nav-dataRombel"
                            aria-selected="false">Rombel</button>
                        <button class="nav-link" id="nav-dataSanitasi-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-dataSanitasi" type="button" role="tab" aria-controls="nav-dataSanitasi"
                            aria-selected="false">Sanitasi</button>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-dataRombel" role="tabpanel" aria-labelledby="nav-dataRombel-tab"
                        tabindex="0">
                        <div class="row mt-4">
                            <div class="col-lg-12">
